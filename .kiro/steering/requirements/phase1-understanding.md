...
**目标**: 让大模型理解原始需求，识别不清晰或需要补充的地方

**重要**: 在这一步，**不要**让大模型直接生成需求文档，只让它做分析和提问。
...
**阶段 2: 需求文档编写**
- 文档: `.kiro/steering/requirements/phase2-writing.md`
- 使用澄清后的需求创建结构化需求文档

---

**记住**: 这个阶段多花时间澄清，可以避免后续大量返工。宁可在这个阶段多问几次，也不要带着疑问进入编写阶段。
